...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="mb-4">
        <h2 class="text-xl mb-2 font-semibold">Recipients</h2>
    ...
    <!-- Edit Message Button -->
    <a href="{{ route('admin.messages', $data) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg ml-2">Edit Message</a>
