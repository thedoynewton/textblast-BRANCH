        ...
        <table class="min-w-full bg-white border border-gray-300">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-2 border-b">Middle Name</th>
                    <th class="py-2 px-2 border-b">Contact</th>
                    <th class="py-2 px-2 border-b">Email</th>
                    <th class="py-2 px-2 border-b">Campus</th>
                    <th class="py-2 px-2 border-b">College</th>
                    <th class="py-2 px-2 border-b">Program</th>
                    <th class="py-2 px-2 border-b">Major</th>
                    <th class="py-2 px-2 border-b">Enrollment Status</th>
                    <th class="py-2 px-2 border-b">Year</th>
                </tr>
            </thead>
            <tbody>
                @foreach($students as $student)
                    <tr class="hover:bg-gray-100">
                        <td class="py-2 px-2 border-b">{{ $student->stud_fname }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->stud_lname }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->stud_mname }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->stud_contact }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->stud_email }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->campus->campus_name }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->college->college_name }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->program->program_name }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->major->major_name ?? 'N/A' }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->enrollment_stat }}</td>
                        <td class="py-2 px-2 border-b">{{ $student->year->year_name }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
