        ...
        <div>
            ...
            <div class="flex items-center justify-center w-full my-10">
                ...
                <div class="ml-2 px-2 py-1 h-6 text-black font-semibold text-xs rounded"
                    style="background-color: rgba(204, 168, 65, 0.4);">
                    edu
                </div>
                <div class="relative">
            ...
            <ul class="mt-5">
                ...
                <li
                    class="{{ request()->routeIs('admin.analytics') ? 'button-selected' : 'button-default button-hover' }} my-3">
                ...
                <li
                    class="{{ request()->routeIs('admin.user-management') ? 'button-selected' : 'button-default button-hover' }} my-3">
