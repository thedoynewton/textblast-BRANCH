<!-- Reusable Modal for Message Templates and Logs -->
<div id="{{ $modalId }}" class="fixed z-10 inset-0 bg-gray-500 bg-opacity-75 transition-opacity hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
